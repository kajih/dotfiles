# Generated by Powerlevel10k configuration wizard on 2020-04-10 at 13:44 CEST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 60244.
# Wizard options: nerdfont-complete + powerline, small icons, classic, dark, 24h time,
# 2 lines, dotted, sparse, concise, transient_prompt, instant_prompt=quiet.
