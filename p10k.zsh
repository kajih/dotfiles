# Generated by Powerlevel10k configuration wizard on 2019-11-29 at 21:40 CET.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 03065.
# Wizard options: compatible, classic, dark, time, blurred tails, 2 lines, disconnected,
# left frame, sparse, concise, transient_prompt, instant_prompt=verbose.
